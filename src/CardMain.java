...
class CardMain extends CardClass {
    ...
    public static void main(String[] args) {
        ...
        //Whatever the last number is in this "hand", it's the last known used card on top of the discard pile
        ...
        while (true) {
            ...
            int playOption = numScan.nextInt();
